...
Public Class DPembelianDepoEdit
    Private Sub btnBatal_Click(sender As Object, e As EventArgs) Handles btnBatal.Click
        UbahPembelian.lblKodeDeposit.Text = cbAkun.Text
        Me.Close()
    End Sub

    Sub GetAkun()

        Dim kodeacc As String = UbahPembelian.lblKodeDeposit.Text
    ...
    Private Sub DPembelianDeposit_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call GetAkun()
        txtNamaSupplier.Text = UbahPembelian.lookUpEdit.Text.ToString
        Call GetSaldoSupplier()
    End Sub

    Sub GetSaldoSupplier()
        cekOpen()
        CMD = New MySqlCommand("SELECT deposit FROM mst_distributor WHERE kode = '" & UbahPembelian.lookUpEdit.EditValue.ToString & "' ", Conn)
        DR = CMD.ExecuteReader
        DR.Read()
