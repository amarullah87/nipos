...
Public Class ImportSaldoPiutang
    ...
    Sub Masuk(ByVal no_faktur As String, ByVal supplier As String,
        ...
        Try
            ...
            cekOpen()
            Dim simpanjurnal As String = "INSERT INTO piutang (no_transaksi, no_faktur, kode_member, tanggal, tanggal_jt, kodeacc, potongan, total, sisa, keterangan, jenis, created_by, created_date) values ('" &
                    txtNoTransaksi.Text & "', '" &
                    no_faktur & "', '" &
                    supplier & "', '" &
                    tgl & "', '" &
            ...
            Call InsertLogTrans(txtNoTransaksi.Text, "CREATE", MainMenu.PanelUser.Text, "SALDO AWAL PIUTANG | KONSUMEN : " & supplier & " TOTAL Rp. " & Format(total, "N0"))
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnImport.Click
        If MessageBox.Show("Apakah Data Sudah Benar...?! ", "", MessageBoxButtons.YesNo) = DialogResult.Yes Then
            ...
            Else
                ...
                Call kosongkan()
                SaldoAwalPiutangForm.Kosongkan()
                Me.Close()
            End If
        End If
    End Sub
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        Process.Start("doc\IMPORT_SALDOAWAL_PIUTANG.xls")
    End Sub
