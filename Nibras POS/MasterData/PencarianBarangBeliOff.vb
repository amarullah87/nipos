...
Public Class PencarianBarangBeliOff
    ...
    Private Sub PencarianBarang_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        TXTCariBarang.Text = TransaksiPembelianOld.txtBarcode.Text
        TXTCariBarang.Focus()
        ...
        If TransaksiPembelianOld.txtBarcode.Text.Contains("'") Then
            namabarang = TransaksiPembelianOld.txtBarcode.Text.Replace("'", "''")
        Else
            namabarang = TransaksiPembelianOld.txtBarcode.Text
        End If
    ...
    Private Sub DGV_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DGV.CellMouseDoubleClick
        If Not IsDBNull(DGV.Rows(e.RowIndex).Cells(0).Value) Then
            ...
            If (DR.HasRows) Then
                ...
                TransaksiPembelianOld.DGV.Rows.Add(DR.Item("kode_item"), DR.Item("nama_barang"), DR.Item("hpj"), 1, minDisc)
                TransaksiPembelianOld.txtBarcode.Clear()
                cekClose()
                ...
                For barisatas As Integer = 0 To TransaksiPembelianOld.DGV.RowCount - 1
                    For barisbawah As Integer = barisatas + 1 To TransaksiPembelianOld.DGV.RowCount - 1
                        If TransaksiPembelianOld.DGV.Rows(barisbawah).Cells(0).Value = TransaksiPembelianOld.DGV.Rows(barisatas).Cells(0).Value Then

                            Dim diskonEdit As Double = TransaksiPembelianOld.DGV.Rows(barisatas).Cells(4).Value / 100
                            Dim qtyEdit As Double = TransaksiPembelianOld.DGV.Rows(barisatas).Cells(3).Value + 1
                            Dim diskonRupiahEdit As Double = (TransaksiPembelianOld.DGV.Rows(barisatas).Cells(2).Value * qtyEdit) * diskonEdit

                            TransaksiPembelianOld.DGV.Rows(barisatas).Cells(3).Value = TransaksiPembelianOld.DGV.Rows(barisatas).Cells(3).Value + 1
                            TransaksiPembelianOld.DGV.Rows(barisatas).Cells(5).Value = (TransaksiPembelianOld.DGV.Rows(barisatas).Cells(2).Value * qtyEdit) - diskonRupiahEdit
                            TransaksiPembelianOld.DGV.Rows.RemoveAt(barisbawah)
                            Call TransaksiPembelianOld.Hitungtransaksi()
                            Exit Sub
                        End If
                    Next
            ...
            Me.Close()
            TransaksiPembelianOld.txtBarcode.Focus()
            TransaksiPembelianOld.txtBarcode.Text = ""
        End If
    End Sub
