...
Public Class PencarianBarangJual
    Dim Raw As String
    ...
    Private Sub PencarianBarang_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        TXTCariBarang.Text = TransaksiPenjualanNhs.txtBarcode.Text
        TXTCariBarang.Focus()
        ...
        If TransaksiPenjualanNhs.txtBarcode.Text.Contains("'") Then
            namabarang = TransaksiPenjualanNhs.txtBarcode.Text.Replace("'", "''")
        Else
            namabarang = TransaksiPenjualanNhs.txtBarcode.Text
        End If
