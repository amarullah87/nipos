...
Public Class DaftarItemKeluar

    Public notransaksi As String = ""
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        notransaksi = ""
        TransaksiItemKeluar.MdiParent = MainMenu
        TransaksiItemKeluar.Show()
        TransaksiItemKeluar.Focus()
    End Sub
    ...
    Sub TampilGrid()
        ...
        cekOpen()
        CMD = New MySqlCommand("SELECT t.*, p.`namaacc` FROM transaksi_barang t INNER JOIN perkiraan p ON p.`kodeacc` = t.`kode_akun` WHERE jenis_transaksi = 0 ORDER BY no_transaksi DESC", Conn)
