...
Public Class DaftarKasKeluar
    ...
    Sub TampilGrid()
        ...
        cekOpen()
        CMD = New MySqlCommand("SELECT * FROM arus_kas a WHERE a.`jenis` = 'keluar' AND tanggal BETWEEN '" & Format(dtpAwal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpAkhir.Value, "yyyy-MM-dd") & "' ", Conn)
        DR = CMD.ExecuteReader

        Do While DR.Read
            DGV.Rows.Add(DR.Item("no_transaksi"), DR.Item("tanggal"), DR.Item("kodeacc"), DR.Item("keterangan"), CDec(DR.Item("jumlah")), DR.Item("created_by"))
        Loop
        cekClose()
    End Sub
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        TambahKasKeluar.MdiParent = MainMenu
        TambahKasKeluar.Show()
        TambahKasKeluar.Focus()
    End Sub
    ...
    Private Sub SimpleButton3_Click(sender As Object, e As EventArgs) Handles SimpleButton3.Click
        ...
        Dim nameFile As String = "Daftar_Kas_Keluar_" & Format(dtpAwal.Value, "yyyy-MM-dd") & "_sd_" & Format(dtpAkhir.Value, "yyyy-MM-dd") & ".csv"
