...
Public Class DaftarKasMasuk
    ...
    Sub TampilGrid()
        ...
        cekOpen()
        CMD = New MySqlCommand("SELECT * FROM arus_kas a WHERE a.`jenis` = 'masuk' AND tanggal BETWEEN '" & Format(dtpAwal.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpAkhir.Value, "yyyy-MM-dd") & "' ", Conn)
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        TambahKasMasuk.MdiParent = MainMenu
        TambahKasMasuk.Show()
        TambahKasMasuk.Focus()
    End Sub
    ...
    Private Sub SimpleButton3_Click(sender As Object, e As EventArgs) Handles SimpleButton3.Click
        ...
        Dim nameFile As String = "Daftar_Kas_Masuk_" & Format(dtpAwal.Value, "yyyy-MM-dd") & "_sd_" & Format(dtpAkhir.Value, "yyyy-MM-dd") & ".csv"
